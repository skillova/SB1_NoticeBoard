...
SECRET_KEY = 'django-insecure-df-3dh5cdiim*di*r-(kf1(n$#j#ot5d%yq07lqnszrk=^o2q7'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'SB1_NoticeBoard', # Название БД
...
# Настройка отправки писем email в Django для yandex.ru
